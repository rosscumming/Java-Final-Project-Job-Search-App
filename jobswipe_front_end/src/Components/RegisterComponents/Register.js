...
class Register extends Component {
  ...
  handleNewUser(event) {
    if (!this.state.name || !this.state.salary || !this.state.location)
      return null;
    const newUser = {
  ...
  isFormValid() {
    return this.state.name && this.state.salary && this.state.location
      ? "./jobs"
      : "./register";
  }
        ...
        <article className="register-article">
          ...
          <form className="register-form">
            ...
            <Link to={this.isFormValid} onClick={this.handleNewUser}>
              <button type="submit" className="link-register">
                Register User
              </button>
            </Link>
          </form>
